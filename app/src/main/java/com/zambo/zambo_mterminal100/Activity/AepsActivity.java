...
//            customer_no=findViewById(R.id.mobile);
            ...
            progressDialog=new ProgressDialog(AepsActivity.this);
            userData = PrefManager.getInstance(AepsActivity.this).getUserData();
...
//                        Toast.makeText(AepsActivity.this,radioButton.getText(),Toast.LENGTH_SHORT).show();
                        if (radioButton.getText().equals("Mantra")) {
                            SplashActivity.savePreferences("device",radioButton.getText().toString());
                            irisvalue = "N";
                            getdevice();
//                     transaction();
                            ...
                            Toast.makeText(AepsActivity.this, "Select Device", Toast.LENGTH_SHORT).show();
                        }
                    }
                }
            });
        bank=findViewById(R.id.bank);
            ...
            gpsTracker = new GPSTracker(AepsActivity.this);
...
//                public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                        if(type_val.equals( "CW")) {
                          ...
                          //  Toast.makeText(AepsActivity.this,"cash",Toast.LENGTH_SHORT).show();
                        }
                        else if (type_val.equals( "BE")){
                         //   Toast.makeText(AepsActivity.this,"balane",Toast.LENGTH_SHORT).show();
...
//    }
    ...
    public void onClick(View v) {
        if (v==imgBack){
            Intent intent = new Intent(AepsActivity.this,CustomerMobile.class);
            startActivity(intent);
            finish();
        }
        if (v==imgWallet){
...
//                    Toast.makeText(AepsActivity.this,""+response.body().get(i).getBankName()+"\n"+response.body().get(i).getIinno(),Toast.LENGTH_SHORT).show();
                ...
                ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(AepsActivity.this, android.R.layout.simple_spinner_item, bankname);
                dataAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
//                bank.setAdapter(dataAdapter);
            ...
            Toast.makeText(AepsActivity.this,""+t,Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void transaction()
    {
        ...
        Gson gson = new GsonBuilder()
                .setLenient()
                .create();
        ProgressDialog progressDialog=new ProgressDialog(AepsActivity.this);
        progressDialog.show();

        SplashActivity.savePreferences("request",jsonArray.toString());
//        Toast.makeText(AepsActivity.this,userData.getToken()+"\n"+bankidd+"\n"+aadhar.getText().toString()+"\n"+type_val+"\n"+customer_no+"\n"+lat+"\n"+lon+"\n"+amt+"\n"+srno+"\n"+userData.getUserId()+"\n"+value1,Toast.LENGTH_LONG).show();
        ...
        Apiinterface apiinterface=retrofit.create(Apiinterface.class);
        Call<com.zambo.zambo_mterminal100.model.Response> call=apiinterface.primeaeps(userData.getToken(),jsonObject.toString(),aadhar.getText().toString(),type_val,customer_no,lat,lon,amt,srno,userData.getUserId(),"APP",value1,irisvalue);
        call.enqueue(new Callback<com.zambo.zambo_mterminal100.model.Response>() {
            ...
            public void onResponse(Call<com.zambo.zambo_mterminal100.model.Response> call, Response<com.zambo.zambo_mterminal100.model.Response> response) {
                ...
                if (response.body().getStatus().equals(0)) {
                    ...
                    Intent intent = new Intent(AepsActivity.this,TransactionReceipt.class);
                    ...
                    if (SplashActivity.getPreferences("Language","").equals("English")) {
                        MediaPlayer mediaPlayer = MediaPlayer.create(AepsActivity.this, R.raw.speech);
                        mediaPlayer.start();
                    }else if (SplashActivity.getPreferences("Language","").equals("Hindi")) {
                        MediaPlayer mediaPlayer = MediaPlayer.create(AepsActivity.this, R.raw.hindispeech);
                        mediaPlayer.start();
                    }
//                    Toast.makeText(AepsActivity.this,status,Toast.LENGTH_SHORT).show();
                    ...
                    if (response.body().getInvoiceData() != null) {
                        Intent intent = new Intent(AepsActivity.this, TransactionReceiptFailed.class);
                        intent.putExtra("status", status);
                        intent.putExtra("txnId", response.body().getTxnid());
                        intent.putExtra("bank", response.body().getInvoiceData().getBankName());
                        intent.putExtra("aadhaar",response.body().getInvoiceData().getAdhaarNumber());
            ...
            public void onFailure(Call<com.zambo.zambo_mterminal100.model.Response> call, Throwable t) {
                progressDialog.dismiss();
                Toast.makeText(AepsActivity.this,"failure"+t,Toast.LENGTH_SHORT).show();
            }
        });
    }
    private void parsejson(String response){
        ...
        try {
            ...
            if(obj.optString("status").equals("true")){
                ...
                Toast.makeText(AepsActivity.this,"data"+obj.optString("message"),Toast.LENGTH_SHORT).show();

            }else {
                Toast.makeText(AepsActivity.this, obj.optString("message")+"", Toast.LENGTH_SHORT).show();
            }
    ...
    public void scanNow( View view){
        ...
        Intent i = new Intent(AepsActivity.this, QrCodeActivity.class);
